const steps = [
  ...
  {
    id: "0.3",
    title: "Build and manage Ontology-powered software, with a complete developer platform",
    description:
      "FOUNDARY",
  ...
  {
    id: "0.4",
    title: "Autonomously deploy, monitor, and manage software across any environment",
    description:
      "APPOLLO",
