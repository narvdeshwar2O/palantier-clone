        ...
        <div className="border-t mt-12">
          ...
          <div className="flex flex-col gap-3 mt-5 flex-1">
            <p>
              ...
              non-profit sectors to help organizations quickly implement
              solutions to the hardest problems they face.
            </p>
            <AnimatedButton title="Learn more about AIP" />
            <hr />
            <div className="flex justify-center">
              <FooterList title="About Palantir" items={menuNavItem} className="text-white"/>
            </div>
          </div>
        </div>
      </div>
